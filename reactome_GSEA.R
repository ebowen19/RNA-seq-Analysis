...
df <- reactome_sensiDown #****REPLACE with whichever dataframe you want to analyze & replace csv name!
...
write.csv(df_aligned, "Aligned_reactome_sensiDown.csv", row.names = FALSE)
complete.cases(df_aligned) # determine common pathways
